...
namespace Defra.PTS.Application.Functions.Application // Moved into a named namespace
{
    /// <summary>
    ...
    public class SignatoryController
    {
        ...
        {
            _logger.LogInformation("Retrieving signatory with ID: {SignatoryId}", signatoryId.ToString()); // Avoid string interpolation
